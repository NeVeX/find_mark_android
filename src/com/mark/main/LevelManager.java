...
import com.mark.main.control.Options;
import com.mark.main.music.MusicManager;
import com.mark.main.quiz.QandA;
import com.mark.main.screens.EndGameScreen;
import com.mark.main.screens.Settings;
...
public class LevelManager extends Activity {
	...
	private static int questionsWrongLimit = 5;
...
//        getButtonDefintions();
    ...
    public void onBackPressed() {
		...
		.setPositiveButton("Whoops - Let Me Continue!", dialogClickListener)
		.setNegativeButton("OMG Mark - Just Let Me Quit - Jeez!", dialogClickListener).show();
    }
...
//		answerButtonC.setTextColor(R.color.markRed);
	...
	private void showDialogBox(boolean isCorrect) {
		...
		if (isCorrect) {  
			...
			messageToDisplay.setText("Woohoo Darling! You Rock!");
			builder.setView(messageToDisplay)
			.setPositiveButton("Yeaaahhh!", dialogClickListener).show();
		}
		else { 
			...
			if ( this.questionsGottenWrong >= questionsWrongLimit ) 
			{
				...
				messageToDisplay.setText("Aww Baby! Do You Even Know Me?? You Got Too Many Wrong Answers! :-(");
				builder.setView(messageToDisplay)
				.setNegativeButton("Ugh, Whatever Mark! I Don't Love You!", dialogClickListener).show();
			}
			else 
			{
				...
				builder.setView(messageToDisplay)
				.setNeutralButton("Whoops! I Still Love You Mark!", dialogClickListener).show();
			}
